...
class NightVendorEvent(battleflyBotEvent):
    ...
    def get_night_vendor_offered_battlefly(self, user_id: str) -> str:
        """
        Gets the offered battlefly from the night vendor
        """
        return self.offers[user_id]["offer"]["pkmn"]

    def get_night_vendor_requested_battlefly(self, user_id: str) -> str:
        """
        Gets the night vendor's requested battlefly
        """
        return self.offers[user_id]["price"]

    def get_night_vendor_offered_battlefly_shiny_status(
        self,
        user_id: str
    ) -> str:
        """
        Gets the shiny status of the offered battlefly from the night vendor
        """
