...
class MiscLogic(battleflyBotModule):
    """Handles the misc logic of features for battleflyBot"""

    def __init__(self, bot):
        self.trainer_service = TrainerService(battleflyBotRates(bot))
    ...
    async def build_trainer_profile_msg(
        ...
        """
        Displays trainer profile and battlefly caught stats
        """
        try:
