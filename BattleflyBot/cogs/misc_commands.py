...
from modules.battleflybot_exceptions import UnregisteredTrainerException


class MiscCommands(battleflyBotCog):
    ...
    async def gif(
        ...
        pkmn_name: str = commands.parameter(
            description="The battlefly name to look up."
        ),
        ...
        """
        Display a gif of the battlefly
        """
